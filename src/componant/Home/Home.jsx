  ...
  return (
    ...
    <div className='overflow-hidden bg-light'>
      <div className="row">
        ...
        <div className="bg-black col-10 px-lg-5 px-2 py-5">
            <div className='text-end me-2'>
            <button onClick={handleShow}  className='btn btn-info text-white '><i className="fa-solid fa-plus"></i> Add Note</button>
            </div>
          <div className="row">
                {userNotes? userNotes.map((note,index)=>(<Note getUserNotes={getUserNotes} deleteNote={deleteNote} key={note._id} noteDetails={note} />)):<p>No notes found</p>}
          </div>
